...
},{"core-js/stable":"95FYz","regenerator-runtime/runtime":"1EBPE","./model.js":"1pVJj","./views/recipeView.js":"82pEw","./views/searchView.js":"jcq1q","./views/resultsView.js":"5peDB","./views/paginationView.js":"2PAUD","./views/bookmarksView.js":"764v9","./views/addRecipeView.js":"Lo2AT","./config.js":"6V52N","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"95FYz":[function(require,module,exports) {
...
const uploadRecipe = async function(newRecipe) {
    try {
        const ingredients = Object.entries(newRecipe).filter((entry)=>entry[0].startsWith('ingredient') && entry[1] !== ''
            ...
            //console.log(ingArr);
            if (ingArr.length !== 3) throw new Error('Wrong ingrediente format! Please use the correct format :)');
...
const API_KEY = 'e9bb56b9-275b-4c5a-95a3-b5fce7f1fc39';
const MODAL_CLOSE_SEC = 2.5; // export const KEY = '10f4afde-6c70-413d-8a9c-a6d1b3b22068';
...
},{"./view":"aXC0x","url:../../img/icons.svg":"5jwFy","../helpers":"9RX9R","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"aXC0x":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"./view":"aXC0x","../../img/icons.svg":"d8AAi","./previewView":"i65ZK","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"i65ZK":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"aXC0x","../../img/icons.svg":"d8AAi","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"2PAUD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
class PaginationView extends _viewDefault.default {
    ...
    _generateMarkup() {
        ...
        if (this.curPage === 1 && numPages > 1) return this._generateMarkupButton('t', 'f');
        //last page
        if (this.curPage === numPages && numPages > 1) return this._generateMarkupButton('f', 't');
        //other page
        if (this.curPage < numPages) return this._generateMarkupButton('t', 't');
        //page 1, and there are no other pages
        return '';
    }
    _generateMarkupButton(n, p) {
        const nextMarkupButton = `<button data-goto="${this.curPage + 1}" class="btn--inline pagination__btn--next">
      <span>Page ${this.curPage + 1}</span>
      <svg class="search__icon">
      <use href="${_iconsSvgDefault.default}#icon-arrow-right"></use>
      </svg>
      </button>`;
        const prevMarkupButton = `<button data-goto="${this.curPage - 1}" class="btn--inline pagination__btn--prev">
      <svg class="search__icon">
      <use href="${_iconsSvgDefault.default}#icon-arrow-left"></use>
      </svg>
      <span>Page ${this.curPage - 1}</span>
      </button>`;
        if (n === 't' && p === 'f') return nextMarkupButton;
        if (n === 'f' && p === 't') {
            console.log(prevMarkupButton);
            return prevMarkupButton;
        }
        if (n === 't' || p === 't') return `${prevMarkupButton}${nextMarkupButton}`;
    }
}
exports.default = new PaginationView();

},{"./view":"aXC0x","../../img/icons.svg":"d8AAi","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"764v9":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
},{"./view":"aXC0x","./previewView":"i65ZK","../../img/icons.svg":"d8AAi","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}],"Lo2AT":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _view = require("./view");
var _viewDefault = parcelHelpers.interopDefault(_view);
...
exports.default = new addRecipeView(); //BUCETAO

},{"./view":"aXC0x","../../img/icons.svg":"d8AAi","@parcel/transformer-js/src/esmodule-helpers.js":"ciiiV"}]},["kS06O","lA0Es"], "lA0Es", "parcelRequire3a11")
